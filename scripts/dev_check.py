    ...
    return [['cargo', 'fmt', '--check'],
            ...
            *[[sys.executable, f'scripts/{name}'] for name in
              ('test_e2e.py', 'test_compaction.py', 'test_providers.py',
               'test_live_acceptance.py', 'test_dev_check.py', 'test_worker_checks.py', 'test_dev_check_host.py', 'test_ccc_node.py', 'test_progress.py', 'test_harness_eval.py', 'test_eval_case.py', 'test_eval_dispatch.py')]]
